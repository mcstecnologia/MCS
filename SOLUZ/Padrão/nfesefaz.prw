...
User Function XmlNfeSef(cTipo,cSerie,cNota,cClieFor,cLoja,cNotaOri,cSerieOri)
	...
	IF lPe01Nfe
		//Customizado SOLUZ - PE01NFESEFAZ
		//-------------------------------------------------------------------
		/*/{Protheus.doc} PE01NFESEFAZ
		Ponto de Entrada para manipular as informações antes de enviar a nota
		Adicionado os Arrays:
		aIPI,aICMS,aICMSST,aPis,aPISST,aCOFINSST,aISSQN,aICMUFDest,aISS,aCOFINS
		@author  Gabriel
		@since   03/2025
		/*/
		//-------------------------------------------------------------------
		aParam := {aProd,cMensCli,cMensFis,aDest,aNota,aInfoItem,aDupl,aTransp,aEntrega,aRetirada,aVeiculo,aReboque,aNfVincRur,aEspVol,aNfVinc/*15*/,;
			aDetPag/*16*/,aObsCont,aProcRef,aMed,aLote,aIPI,aICMS,aICMSST,aPis,aPISST,aCOFINSST,aISSQN,aICMUFDest,aISS,aCOFINS}
